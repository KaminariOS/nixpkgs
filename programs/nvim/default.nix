...
# }}}
{
  ...
  xdg.configFile."nvim/lua".source = mkOutOfStoreSymlink "/home/kosumi/.config/nixpkgs/lua";
  xdg.configFile."nvim/colors".source = mkOutOfStoreSymlink "/home/kosumi/.config/nixpkgs/colors";
