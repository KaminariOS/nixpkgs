{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-3e0a26e6-1ed2-4027-a1c1-b96a5b9312ab" = [ ];
    ...
    files = {
      ...
      "dolphinrc"."Open-with settings"."History" = "con";
      "dolphinrc"."Search"."Location" = "Everywhere";
      "kactivitymanagerdrc"."activities"."3e0a26e6-1ed2-4027-a1c1-b96a5b9312ab" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "3e0a26e6-1ed2-4027-a1c1-b96a5b9312ab";
      ...
      "kdeglobals"."KFileDialog Settings"."Speedbar Width" = 279;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{6e08422a-5541-4668-9268-7048d8e32483}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{d593a8ce-56fc-4bf7-b079-c371b747f979}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{df3ef9f3-9061-49a7-b5fc-cc7fe85a236f}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{49ff4259-11a2-4382-b8ff-22430f4e8d94}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{78b8bf05-2bd8-42b9-8386-f7b1548d2ac1}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{d4a92b0f-68ea-4b30-9f27-d8d7719f87fd}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{34e0d132-2405-40eb-90ec-61b30137ef15}";
      ...
      "kscreenlockerrc"."Daemon"."Timeout" = 40;
      "kscreenlockerrc"."Greeter"."WallpaperPlugin" = "org.kde.potd";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/home/kosumi/.local/share/wallpapers/4K KDE Plasma Abstract 345 NO LOGO.png";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.potd.General"."Provider" = "unsplash";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Compositing"."OpenGLIsUnsafe" = false;
      "kwinrc"."Desktops"."Id_1" = "5f4b1ec4-553a-4026-9193-ca306cfae441";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling.39a7f1bd-15bd-562a-b5a9-ca52910ebf5a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "systemsettingsrc"."Open-with settings"."History" = "chrom,firefox,kitt";
    };
  };
}
